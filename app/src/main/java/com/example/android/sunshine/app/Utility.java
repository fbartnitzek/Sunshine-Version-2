...
//        SimpleDateFormat dbDateFormat = new SimpleDateFormat(Utility.DATE_FORMAT);
    ...
    public static int getContentDescription(int weatherId) {

        if (weatherId >= 200 && weatherId <= 232) {
            return R.string.pic_desc_storm;
        } else if (weatherId >= 300 && weatherId <= 321) {
            return R.string.pic_desc_drizzle;
        } else if (weatherId >= 500 && weatherId <= 504) {
            return R.string.pic_desc_rain;
        } else if (weatherId == 511) {
            return R.string.pic_desc_freezing_rain;
        } else if (weatherId >= 520 && weatherId <= 531) {
            return R.string.pic_desc_shower_rain;
        } else if (weatherId >= 600 && weatherId <= 622) {
            return R.string.pic_desc_snow;
        } else if (weatherId >= 701 && weatherId <= 761) {
            return R.string.pic_desc_fog;
        } else if (weatherId == 761 || weatherId == 781) {
            return R.string.pic_desc_storm;
        } else if (weatherId == 800) {
            return R.string.pic_desc_clear;
        } else if (weatherId == 801) {
            return R.string.pic_desc_light_clouds;
        } else if (weatherId >= 802 && weatherId <= 804) {
            return R.string.pic_desc_clouds;
        }
        return R.string.pic_desc_unknown;
    }
    ...
    public static void resetLocationStatus(Context c) {
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key),
                SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();    //because called from the ui-thread
    }
